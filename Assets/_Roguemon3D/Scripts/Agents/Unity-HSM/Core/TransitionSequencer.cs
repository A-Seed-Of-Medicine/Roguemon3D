...
namespace HSM {
    public class TransitionSequencer {
        ...
        public State ActiveTransitionTo => IsTransitioning ? activeTo : null;
        public (State from, State to)? PendingTransition => pending;
        public State LastRequestedFrom { get; private set; }
        public State LastRequestedTo { get; private set; }
        public State LastCompletedFrom => lastCompletedFrom;
        public State LastCompletedTo => lastCompletedTo;
        public (State from, State to)? LastCompletedTransition =>
            lastCompletedFrom != null || lastCompletedTo != null ? (lastCompletedFrom, lastCompletedTo) : null;
        ...
        void EndTransition() {
            lastCompletedFrom = activeFrom;
            lastCompletedTo = activeTo;
            activeFrom = null;
            activeTo = null;
            sequencer = null;
