...
namespace _PinBoy.Scripts.Gameplay.Actions.Editor
{
    ...
    public class ComboGraphEditorWindow : EditorWindow
    {
        ...
        void ResetStep(SerializedProperty step, int index)
        {
            ...
            step.FindPropertyRelative("chargeWindup").boolValue = false;
            step.FindPropertyRelative("minimumChargeTime").floatValue = 0f;
            step.FindPropertyRelative("maximumChargeTime").floatValue = 0f;
            SerializedProperty movementLocks = step.FindPropertyRelative("movementLocks");
            movementLocks.FindPropertyRelative("windup").boolValue = true;
            movementLocks.FindPropertyRelative("active").boolValue = true;
            movementLocks.FindPropertyRelative("recovery").boolValue = true;
            SerializedProperty chargeMovementLocks = step.FindPropertyRelative("chargeMovementLocks");
            chargeMovementLocks.FindPropertyRelative("windup").boolValue = true;
            chargeMovementLocks.FindPropertyRelative("active").boolValue = true;
            chargeMovementLocks.FindPropertyRelative("recovery").boolValue = true;
