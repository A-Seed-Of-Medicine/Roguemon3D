...
namespace _PinBoy.Scripts.Gameplay.Actions.Editor
{
    ...
    public class ComboGraphEditorWindow : EditorWindow
    {
        ...
        void ResetStep(SerializedProperty step, int index)
        {
            ...
            step.FindPropertyRelative("minimumChargeTime").floatValue = 0.05f;
            ...
            step.FindPropertyRelative("lockAimInWindup").boolValue = true;
            step.FindPropertyRelative("lockAimInActive").boolValue = true;
            step.FindPropertyRelative("lockAimInRecovery").boolValue = true;
