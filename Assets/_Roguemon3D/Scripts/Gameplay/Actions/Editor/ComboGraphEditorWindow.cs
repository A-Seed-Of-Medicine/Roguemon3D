...
namespace _PinBoy.Scripts.Gameplay.Actions.Editor
{
    ...
    public class ComboGraphEditorWindow : EditorWindow
    {
        ...
        void ResetStep(SerializedProperty step, int index)
        {
            ...
            SerializedProperty movementLocks = step.FindPropertyRelative("movementLocks");
            movementLocks.FindPropertyRelative("lockInWindup").boolValue = true;
            movementLocks.FindPropertyRelative("lockInActive").boolValue = true;
            movementLocks.FindPropertyRelative("lockInRecovery").boolValue = true;
            ...
            SerializedProperty chargeSettings = step.FindPropertyRelative("chargeSettings");
            chargeSettings.FindPropertyRelative("chargeWindup").boolValue = false;
            chargeSettings.FindPropertyRelative("minimumChargeTime").floatValue = 0f;
            chargeSettings.FindPropertyRelative("maximumChargeTime").floatValue = 0f;
            SerializedProperty chargeLocks = chargeSettings.FindPropertyRelative("movementLocks");
            chargeLocks.FindPropertyRelative("lockInWindup").boolValue = true;
            chargeLocks.FindPropertyRelative("lockInActive").boolValue = true;
            chargeLocks.FindPropertyRelative("lockInRecovery").boolValue = true;
